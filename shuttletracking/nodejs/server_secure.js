...
//E:/Apache24/ssl/crt/ssl_certificate.crt
//E:/Apache24/ssl/private/wayprivate.key
//E:/Apache24/ssl/crt/IntermediateCA.crt
...
var key = fs.readFileSync('E:/Apache24/ssl/private/wayprivate.key', 'utf8')
,   cert  = fs.readFileSync('E:/Apache24/ssl/crt/ssl_certificate.crt', 'utf8');
...
var privateKey = fs.readFileSync('E:/Apache24/ssl/private/wayprivate.key');
var certificate = fs.readFileSync('E:/Apache24/ssl/crt/ssl_certificate.crt');
...
//            callback.json({"code" : 100, "status" : "Error in connection database"});
            ...
            con.query('SELECT * FROM tbl_shuttle_driver_log where SDL_DriverID = "' + SDL_DriverID + '" and SDL_ParkingID = "'+ room_id +'"  and SDL_LogID = "' + insertedLogID + '" limit 1', function (err, rows) {
                ...
                console.log('update tbl_shuttle_driver_log set SDL_JSONData = "' + mysql_real_escape_string(jsonDetail) + '", SDL_EndDateTime = "' + end_datetime + '" where SDL_DriverID = "' + SDL_DriverID + '" and SDL_ParkingID = "'+ room_id +'" and SDL_LogID = "' + insertedLogID + '"');
                if (rows != '') {
