...
if(isset($_POST['Pass_submit'])) 
{
	...
	{
		echo "<script language='javascript'>location.href=('http://letsnurture.co.uk/demo/dinning/change_password.php?Report=Error');</script>";		
	}
	
}
?>
<script language="javascript" type="text/javascript" src="http://letsnurture.co.uk/demo/dinning/jscripts/validation.js"></script>
