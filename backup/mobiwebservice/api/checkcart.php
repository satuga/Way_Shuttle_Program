<?php
	...
	{	
		...
		VALUES 
		('','".$_REQUEST['MID']."',".$result1['Owner_ID'].",'".mysqli_real_escape_string($con,$orderdate)."','".mysqli_real_escape_string($con,$_REQUEST['ordertime'])."','".$_REQUEST["User_ID"]."',NOW(),'".mysqli_real_escape_string($con,$_REQUEST['orderfor'])."','".mysqli_real_escape_string($con,$_REQUEST['orderAmount'])."','Pending','Due','Cash','".mysqli_real_escape_string($con,$_REQUEST['tax_total'])."','".mysqli_real_escape_string($con,$_REQUEST['deliveryFee'])."')"; 
