...
<table width="830" border="0" align="center" cellpadding="0" cellspacing="0" style="border:1px solid #00a7d4;">
  <tr>
    <td height="700" valign="top" background="http://www.bi.way.com/alpha/template/images/img-topbg-1.gif" scope="col" style="background-repeat:no-repeat; background-position:top;"><table width="100%" border="0" cellspacing="0" cellpadding="0">
      <tr>
  ...
  <tr>
	...
	<tr>
          ...
          <tr>
            <td scope="col"><div align="center" style="font-family:Arial, Helvetica, sans-serif; font-size:14px; font-weight: normal; line-height:22px; color:#4e4e4e;">
             ...
             <span style="font-family:Arial, Helvetica, sans-serif; font-size:14px; font-weight: bold; line-height:22px; color:#4e4e4e;">The Way.com Team</span><br />
               <a style="text-decoration:none;"href="http://www.bi.way.com/alpha/"><span style="font-family:Arial, Helvetica, sans-serif; font-size:14px; font-weight: normal; line-height:22px; color:#0b9fd8;text-decoration:none;">www.bi.way.com</span></a></div>
            </div></td>
          </tr>
        </table></td>
      </tr>
	  ...
	  <tr>
	  <td><img src="http://www.bi.way.com/alpha/template/images/img_dotted.gif" border="0"></td>
	  </tr>
	<tr>
