...
/************************************************************
FILE :	FeaturedBookingInfoManagerDO.php
PURPOSE: Future Booking Info   
AUTHOR: Gopalan Mani
DATE  : 18 FEB 2015
**************************************************************/

class FeaturedBookingInfoManagerDO {

private $p_IsFeaturedBooking= null;
private $p_BookingID= null;
private $p_EntryDateTime= null;
...
protected function EntryDateTime($value = "")
{
if (empty($value)) // getter
	{
		if ($this-> p_EntryDateTime != null)
			return $this->p_EntryDateTime;
	}
	else // setter
	{
		$this-> p_EntryDateTime = $value;
	}
...
protected function IsFeaturedBooking($value = "")
{
if (empty($value)) // getter
	{
		if ($this-> p_IsFeaturedBooking != null)
			return $this->p_IsFeaturedBooking;
	}
	else // setter
	{
		$this-> p_IsFeaturedBooking = $value;
	}
...
protected function BookingID($value = "")
{
if (empty($value)) // getter
	{
		if ($this-> p_BookingID != null)
			return $this->p_BookingID;
	}
	else // setter
	{
		$this-> p_BookingID = $value;
	}
