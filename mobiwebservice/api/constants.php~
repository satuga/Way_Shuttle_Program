<?php
/* bi.way.com credentials - 32 server */
//define("DB_SERVER","localhost");
//define("DB_USERNAME","root");
//define("DB_PASSWORD","Sapconf18");
//define("DB_DATABASE","way_livedbfortest");
define("DB_SERVER","localhost");
define("DB_USERNAME","root");
define("DB_PASSWORD","ln");
define("DB_DATABASE","waybi");
//*/
/* way.com credentials - 10 server * /

define("DB_SERVER","192.168.168.37");
define("DB_USERNAME","band");
//define("DB_PASSWORD","Sap27Conf@47");
define("DB_PASSWORD","WayConf@DB061316!");
define("DB_DATABASE","way_livedb");
*/
// */
define("ENCRYPTKEY","Archu@19!@14!"); // sapconf747 is new key
...
define("HOSTPATH","http://www.way.com/responsive/mobiwebservice/api/");
define("IMAGEPATH","http://www.way.com/responsive/mobiwebservice/api/admin/upload/users/");
