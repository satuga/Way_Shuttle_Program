...
if($id!='')
{
    $rest=str_replace("!","",str_replace(" ","-",str_replace("&","and",str_replace(".","",str_replace("`","",str_replace("'","",str_replace("(","",str_replace(")","",GetRestaurantname($id)))))))));
    //$rest=str_replace("--","-",(str_replace(" ","-",GetRestaurantname($id))));
    ...
    // $unsigned_url = "http://api.yelp.com/v2/search?term=".GetRestaurantname($id)."&location=".$restcity;
