...
else
{
	...
	$sql="UPDATE tbl_creditcarddetails SET Card_Type='".mysqli_real_escape_string($con,$_REQUEST['payment_method'])."',Card_Number=AES_ENCRYPT('".mysqli_real_escape_string($con,$card_number)."','".$EncryptKey."'),Card_Exp_Month='".mysqli_real_escape_string($con,$_REQUEST['exp_month'])."',Card_Exp_Year='".mysqli_real_escape_string($con,$_REQUEST['exp_date'])."',Card_FirstName='".mysqli_real_escape_string($con,$_REQUEST['CC_First_Name'])."',Card_Street='".mysqli_real_escape_string($con,$_REQUEST['Street_Address'])."',Card_State='".mysqli_real_escape_string($con,$_REQUEST['State'])."',Card_City='".mysqli_real_escape_string($con,$_REQUEST['City'])."',Card_Zip='".mysqli_real_escape_string($con,$_REQUEST['Zip_Code'])."' WHERE Card_ID=".$Card_ID;
