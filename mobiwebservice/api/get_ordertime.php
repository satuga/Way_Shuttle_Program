...
$selected=sanitize($_REQUEST['date']);
...
$Open_Times=$objdine->Restaurant_OpenHours(sanitize($_REQUEST['id']),$weekday,sanitize($_REQUEST['orderfor']));
...
$content=array("data"=>$order_times);
