...
{	
	...
	if($ResCCNum<1)
	{
		$sql="INSERT INTO tbl_creditcarddetails(Card_User_ID,Card_Type,Card_Number,Card_Exp_Month,Card_Exp_Year,Card_FirstName,Card_Street,Card_City,Card_State,Card_Zip,Card_Created)VALUES(".$User_ID.",'".mysqli_real_escape_string($con,$data['data']['payment_method'])."',AES_ENCRYPT('".mysqli_real_escape_string($con,$card_number)."','".$EncryptKey."'),'".mysqli_real_escape_string($con,$data['data']['exp_month'])."','".mysqli_real_escape_string($con,$data['data']['exp_date'])."','".mysqli_real_escape_string($con,$data['data']['CC_First_Name'])."','".mysqli_real_escape_string($con,$data['data']['Street_Address'])."','".mysqli_real_escape_string($con,$data['data']['City'])."','".mysqli_real_escape_string($con,$data['data']['State'])."','".mysqli_real_escape_string($con,$data['data']['Zip_Code'])."',Now())";
	...
	else
	{
		...
		$sql="UPDATE tbl_creditcarddetails SET Card_Type='".mysqli_real_escape_string($con,$data['data']['payment_method'])."',Card_Number='".$encrypted_card_number."',Card_Exp_Month='".mysqli_real_escape_string($con,$data['data']['exp_month'])."',Card_Exp_Year='".mysqli_real_escape_string($con,$data['data']['exp_date'])."',Card_FirstName='".mysqli_real_escape_string($con,$data['data']['CC_First_Name'])."',Card_Street='".mysqli_real_escape_string($con,$data['data']['Street_Address'])."',Card_State='".mysqli_real_escape_string($con,$data['data']['State'])."',Card_City='".mysqli_real_escape_string($con,$data['data']['City'])."',Card_Zip='".mysqli_real_escape_string($con,$data['data']['Zip_Code'])."' WHERE Card_ID=".$Card_ID;
	...
	if($TransactionResult=='APPROVED' && $TransactionID>0)
	{
		...
		if($Pnum>0)
		{
			...
			if($data['data']['Instructions'.$pk]=='Enter special instructions for your order here:')
				...
				$Instructions=mysqli_real_escape_string($con,$data['data']['Instructions'.$pk]);	
			...
			$rand=genRandomString();
		 	...
		 	$Query1="INSERT INTO tbl_packagetransaction(T_ID,T_Package,T_UsrID,T_TotalAmount,T_Created,Card_Type,Card_Name,Card_Number,Card_Expiry_Month,Card_Expiry_Year,Card_Zip,Card_Address,Card_State,Card_City,DeliveryMethod,DeliveryState,DeliveryCity,DeliveryZip,DeliveryEmail,DeliveryAddress,PaymentDesc,code) VALUES ('',".$PRes1['Cart_Package'].",".$data['data']['User_ID'].",".$PRes1['TAMT'].",Now(),'".mysqli_real_escape_string($con,$ResCC['Card_Type'])."','".mysqli_real_escape_string($con,$ResCC['Card_FirstName'])."',AES_ENCRYPT('".$ResCC['CC_NUMBER']."','".$EncryptKey."'),'".mysqli_real_escape_string($con,$ResCC['Card_Exp_Month'])."','".mysqli_real_escape_string($con,$ResCC['Card_Exp_Year'])."','".mysqli_real_escape_string($con,$ResCC['Card_Zip'])."','".mysqli_real_escape_string($con,$ResCC['Card_Street'])."','".mysqli_real_escape_string($con,$ResCC['Card_State'])."','".mysqli_real_escape_string($con,$ResCC['Card_City'])."','".mysqli_real_escape_string($con,$data['data']['DeliveryMethod'.$pk])."','".mysqli_real_escape_string($con,$data['data']['State'.$pk])."','".mysqli_real_escape_string($con,$data['data']['City'.$pk])."','".mysqli_real_escape_string($con,$data['data']['Zip_Code'.$pk])."','".mysqli_real_escape_string($con,$Delivery_Email)."','".mysqli_real_escape_string($con,$Delivery_Address)."','".$Instructions."','".$code."')";
			...
			while ($PRes=mysqli_fetch_array($res)) 
			{
				...
				$Query="INSERT INTO tbl_packagetransactionitems(PTI_ID,PTI_TID,PTI_ItemID,PTI_Amount,PTI_Quantity,PTI_TotalAmount,DeliveryMethod,DeliveryEmail,DeliveryAddress,PaymentDesc) VALUES ('',".$PTI_TID.",".$PRes['Cart_Item'].",".$PRes['Cart_Amount'].",".$PRes['Cart_Quantity'].",".$PRes['Cart_TotalAmount'].",'".mysqli_real_escape_string($con,$data['data']['DeliveryMethod'.$pk])."','".mysqli_real_escape_string($con,$Delivery_Email)."','".mysqli_real_escape_string($con,$Delivery_Address)."','".$Instructions."')";
		...
		if($DineTran>0)
		{
			...
			if($data['data']['deliveryFee']=='')
				...
				$deliveryFee=mysqli_real_escape_string($con,$data['data']['deliveryFee']);
			if($data['data']['POINTS']>0)
				$sess_points=mysqli_real_escape_string($con,$data['data']['POINTS']);
			else
				$sess_points=0;
			...
			VALUES 
			('".$data['data']['MID']."',".$result['Owner_ID'].",'".mysqli_real_escape_string($con,$orderdate)."','".$data['data']['ordertime']."','".$User_ID."',NOW(),'".mysqli_real_escape_string($con,$data['data']['orderfor'])."','".mysqli_real_escape_string($con,$data['data']['orderAmount'])."','Pending','".$paymentStatus."','".mysqli_real_escape_string($con,$data['data']['pay_type'])."','".mysqli_real_escape_string($con,$data['data']['tax_total'])."','".mysqli_real_escape_string($con,$data['data']['discount'])."','".$sess_points."','".$Points."','".$deliveryFee."','".mysqli_real_escape_string($con,$data['data']['comments'])."','".mysqli_real_escape_string($con,$ResCC['Card_Type'])."','".mysqli_real_escape_string($con,$ResCC['Card_FirstName'])."',AES_ENCRYPT('".$ResCC['CC_NUMBER']."','".$EncryptKey."'),'".mysqli_real_escape_string($con,$ResCC['Card_Exp_Month'])."','".mysqli_real_escape_string($con,$ResCC['Card_Exp_Year'])."','".mysqli_real_escape_string($con,$ResCC['Card_Zip'])."','".mysqli_real_escape_string($con,$ResCC['Card_Street'])."','".mysqli_real_escape_string($con,$ResCC['Card_State'])."','".mysqli_real_escape_string($con,$ResCC['Card_City'])."','".$code."','".mysqli_real_escape_string($con,$Delivery_Address)."','".mysqli_real_escape_string($con,$Instructions)."','".$data['data']['delivery_lat']."','".$data['data']['delivery_long']."')"; 
