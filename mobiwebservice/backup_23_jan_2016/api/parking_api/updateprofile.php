...
if(isset($_REQUEST['firstname']) && isset($_REQUEST['lastname']) && isset($_REQUEST['userid']))
{
    ...
    $sql ="update tbl_registeration set firstname='".mysql_real_escape_string($firstname)."',lastname='".mysql_real_escape_string($lastname)."',logo='".$new_file_name."' where id=".$userid; 
    $rec=mysql_query($sql);
    if($rec){
